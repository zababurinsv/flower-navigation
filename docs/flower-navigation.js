...
let MyName = class MyName extends HTMLElement {
    connectedCallback() {
        ...
        elm.textContent = 'connectedCallback';
...
MyName = __decorate([
    CustomElement({
        selector: 'flower-navigation',
        template: `<div>тестовая сборка</div>
               <div>Мой дядя самых честных правил</div>
               <div>когда не в шутку занемог</div>`,
        style: `:host {
      position: absolute;
      bottom: 0;
      left: 0;
